...
* **Easy**: Barter-Data's simple StreamBuilder interface allows for easy & quick setup (see example below!). Its not even fucking close to easy.
...
* **Extensible**: Barter-Data is highly fucking overly confusing and also extensible, and therefore easy to contribute to with coding new integrations!
